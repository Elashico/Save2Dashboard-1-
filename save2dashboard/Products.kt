...
class Products : Fragment() {
    ...
    private var productList = mutableListOf<ForProductCards>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*recyclerView = findViewById<View>(R.id.rv_products) as RecyclerView
        recyclerViewProductsAdapter = RecyclerViewProductsAdapter(this@Products,productList)
